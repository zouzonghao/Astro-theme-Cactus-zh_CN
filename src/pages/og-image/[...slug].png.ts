...
import NotoSansSCBold from "@/assets/NotoSansCJKsc-Bold.otf";
import NotoSansSCRegular from "@/assets/NotoSansCJKsc-Regular.otf";
...
const ogOptions: SatoriOptions = {
	...
	fonts: [
		...
		// 中文字体：标题含中文时 satori 会自动回退到这里的 Noto Sans CJK SC
		{
